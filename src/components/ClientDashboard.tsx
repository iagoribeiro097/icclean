                      ...
                      >
                        ...
                        <div className="grid sm:grid-cols-2 gap-3 text-xs text-slate-600">
                          <div className="flex items-center gap-2">
                            ...
                            <span>
                              <strong className="text-slate-900">Data e Hora:</strong> {booking.date && typeof booking.date === 'string' && booking.date.includes('-') ? booking.date.split('-').reverse().join('/') : (booking.date || '')} às {booking.time}
                            </span>
                          </div>
                          <div className="flex items-center gap-2">
